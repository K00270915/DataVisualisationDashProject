...
################################### My Code ###################################
    ...
    dcc.Tabs(id="tabs-example", children=[
        ...
        dcc.Tab(label="Quality Of Coffee Over Time (Animated)", children=[
            ...
            html.P("Thickness vs blend over time is a bit interesting as the countries tend to be grouped pretty closely throughout the years in terms of value fluctiations. There was a rise in the the thickness of coffee over the years, especially in the United States in 2012 /2013. Colombia in terms of balancing the flavor comonents of the coffee shoots up in value after 2016. Looking at the other diagrams in the dashboard and seeing a consistency in the sweetness of coffee and species of coffee used, another factor that could have influenced the coffee balance positively strong points to the processing methood used in recent times."),
